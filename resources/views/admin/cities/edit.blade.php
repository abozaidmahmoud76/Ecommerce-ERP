...
<form class="col-lg-6 col-lg-offset-2" method="post" action="{{route('cities.update',$item->id)}}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" required class="form-control" name="city_name_ar" value="{{$item->city_name_ar}}" placeholder="">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group ">
            ...
            <input type="text" required class="form-control " name="city_name_en" value="{{$item->city_name_en}}" >
        </div>
    ...
    <a href="{{url(adminUrl('cities'))}}" class="btn btn-info"><i class="fa fa-arrow-circle-left"></i> {{__('admin.back')}}</a>
