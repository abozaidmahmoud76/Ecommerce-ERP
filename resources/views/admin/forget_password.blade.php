...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('design/AdminLTE/plugins/iCheck/square/blue.css')}}">
    ...
    <div class="login-box-body">
        ...
        <form action="{{url('admin/forget/password')}}" method="post">
            ...
            <div class="row">
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">Rest password </button>
                </div>
                <!-- /.col -->
            </div>
        </form>
...
<!-- Bootstrap 3.3.7 -->
<script src="{{asset('design/AdminLTE/wer_components/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<!-- iCheck -->
<script src="{{asset('design/AdminLTE/ugins/iCheck/icheck.min.js')}}"></script>
<script>
    $(function () {
        $('input').iCheck({
