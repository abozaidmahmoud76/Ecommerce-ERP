...
<div id="modalDelete{{$id}}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <p class="alert alert-danger">are you sure to delete<span> {{ session('lang')=='ar'?$state_name_ar:$state_name_en  }} </span></p>
      </div>
      <div class="modal-footer">
      <form method="post" action="{{route('states.destroy',$id)}}">
            {{csrf_field()}}
            {{method_field('delete')}}
