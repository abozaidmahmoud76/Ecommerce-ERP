...
class StateController extends Controller
{
    ...
    public function create()
    {
        ...
        $cites=City::all();
        return view('admin.states.create',['title'=>__('admin.Add'),'countries'=>$countries,'cites'=>$cites]);
    }
    ...
    public function edit($id)
    {
        ...
        $cites=City::all();
        $item=State::find($id);
       return view('admin.states.edit',['title'=>'Edit State','item'=>$item,'countries'=>$countries,'cites'=>$cites]);
    }
